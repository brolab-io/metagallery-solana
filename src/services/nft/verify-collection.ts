...
export async function verifyCollection({
  ...
  const metadataPDA = PublicKey.findProgramAddressSync(
    [Buffer.from("metadata"), programPubkey.toBuffer(), mint.toBuffer()],
    programPubkey
  )[0];
  const collectionMetadataPDA = PublicKey.findProgramAddressSync(
    [Buffer.from("metadata"), programPubkey.toBuffer(), mintCollection.toBuffer()],
    programPubkey
  )[0];
  const masterCollectionPDA = PublicKey.findProgramAddressSync(
    [
